...
const MenuSection = ({ pizzaFlavors, addToCart }) => {
  return (
    <div className="space-y-8">
      <div className="text-center space-y-4">
        <h1 className="text-3xl md:text-4xl font-bold text-white">Nuestro Menú de Pizzas</h1>
        <p className="text-orange-200">Haz clic en una pizza para añadirla a tu pedido</p>
      </div>
        ...
        {pizzaFlavors.map((pizza) => (
            ...
            >
              ...
              <div className="p-4 pt-2">
                <p className="text-orange-200 text-sm">{pizza.description}</p>
              </div>
            </motion.div>
        ))}
      </div>
